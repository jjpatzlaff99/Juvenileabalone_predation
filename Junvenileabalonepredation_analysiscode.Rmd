...
abpredation<-read.csv("Juvenileabalone_predation_SNISCI23_24withexclusions.xl.csv",header=T)
...
#exclude any irrelevant columns, filter out controls + nas
abpredation2 <- abpredation %>% 
  select(-c(8:9, 20, 21, 27:29, 34:35, 40)) %>% 
  filter(!is.na(Predated.1)) %>% #filter out any rows where Predated = NA
  filter(Control=="Not control") 
view(abpredation2)
...
###Shell remain in lab
```{r}
labteth<-read.csv("Labtethering_juv_abalone_predation1.csv",header=T)
...
Figure_2 <- abpredationspaceprop1 %>%
 ggplot() +
  ...
  facet_grid(.~Island, scales = "free_x", space = "free_x")
Figure_2
ggsave("Figure_2.png", Figure_2, width = 7, height = 4, units = "in")
```
...
Figure_3a <- abpredationshellprop1 %>%
 ...
 ggplot() +
  ...
  facet_grid(.~Site)
Figure_3a
ggsave("Figure_a2a.png", Figure_3a, width = 7, height = 4, units = "in")
...
Figure_3b <- abpredationshellprop1 %>%
 ...
 ggplot() +
  ...
  facet_grid(.~Site)
Figure_3b
ggsave("Figure_a2b.png", Figure_3b, width = 7, height = 4, units = "in")
```
...
Figure_4a
ggsave("Figure_4a.png", Figure_4a, width = 3.5, height = 4, units = "in")
...
Figure_4b
ggsave("Figure_4b.png", Figure_4b, width = 3.5, height = 4, units = "in")
...
Figure_4c
ggsave("Figure_4c.png", Figure_4c, width = 3.5, height = 4, units = "in")
...
Figure_4d
ggsave("Figure_4d.png", Figure_4d, width = 3.5, height = 4, units = "in")
```
...
Figure_5
ggsave("Figure_5.png", Figure_5, width = 7, height = 4, units = "in")
```
...
Figure_a1 <- abpredationmeanland %>%
 ggplot() +
  ...
  facet_grid(.~Island, scales = "free_x", space = "free_x")
Figure_a1
ggsave("Figure_a1.png", Figure_a1, width = 7, height = 4, units = "in")
```
...
Figure_3a
ggsave("Figure_3a.png", Figure_3a, width = 3.5, height = 4, units = "in")
...
Figure_3b
ggsave("Figure_3b.png", Figure_3b, width = 3.5, height = 4, units = "in")
